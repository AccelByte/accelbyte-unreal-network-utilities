...
The setup and implementation guideline are available in [our portal](https://docs.accelbyte.io/gaming-services/modules/multiplayer/peer-to-peer/configure-P2P-matchmaking-oss/).